...
int main()
{
  ...
  int num_of_neighbours_sum_10 = 0;
  ...
  for (int i = 0; i < x.size() - 1; i++)
  {
    ...
    if (x[i] + x[i + 1] == 10)
    {
      num_of_neighbours_sum_10++;
    }
  }

  std::cout << "Liczba sąsiadujących elementów: " << num_of_neighbours << std::endl;
  std::cout << "Liczba sąsiadujących elementów o sumie 10: " << num_of_neighbours_sum_10 << std::endl;
